...
function Home(){
    ...
    return(
        <HomeLayout>
            <div className="p-10 text-white  flex items-center justify-center gap-10 mx-16 h-[90vh]">
                ...
                <div className="w-1/2 space-y-6">
                    ...
                    <p className="text-xl text-gray-200">
                        We have a large library of courses taught by  highly skilled and qualified faculties at a very affaordable cost.
                    </p>
